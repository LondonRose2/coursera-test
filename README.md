...
<head>
    ...
    <meta keywords="English, learn English, Business English, Online English, Cheap English Class, English Stories, English Learning, 英文，綫上英文課程, one-on-one English class, English teacher">
    <title>Let's Talk in English</title>
    <link rel="stylesheet" href="../css/stylesheet.css">
    <link rel="stylesheet" href="../css/normalize.css">
    <link rel="js" href="../javascript/js.js">
</head>
<body>
...
<!--Black Ribbon: English Group Classes-->
...
<div class="w3-content w3-section" style="max-width:100%">
    <img class="mySlides" src="../images/about1.png" style="width:100%">
    <img class="mySlides" src="../images/about2.png" style="width:100%">
    <img class="mySlides" src="../images/about3.png" style="width:100%">
    <img class="mySlides" src="../images/about4.png" style="width:100%">
    <img class="mySlides" src="../images/about5.png" style="width:100%">
    <img class="mySlides" src="../images/about6.png" style="width:100%">
